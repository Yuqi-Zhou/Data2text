...
def main():
    ...
    fields, model, model_opt = onmt.ModelConstructor.load_test_model(
        opt, dummy_opt.__dict__, stage1=True)

    model2 = None
    if opt.model2 is not None:
        fields2, model2, model_opt2 = onmt.ModelConstructor.load_test_model(
            opt, dummy_opt.__dict__, stage1=False)

    # File to write sentences to.
    tools.check_path(opt.output)
