...
def train_opts(parser):
    ...
    group.add_argument('-train_from1', default='', type=str,
                       help="""If training from a checkpoint then this is the
                       path to the pretrained model's state_dict. stage1 model""")
    group.add_argument('-train_from2', default='', type=str,
                       help="""If training from a checkpoint then this is the
                       path to the pretrained model's state_dict. stage2 model""")
    group.add_argument('-from_scratch', default='', type=str,
                       help="""If training from a checkpoint then this is the
                       path to the pretrained model's state_dict. stage1 model""")
    group.add_argument('-lm_finetune',
                       action='store_true',
                       help="finetune stage2 decoder loss with regularization")
    ...
    group.add_argument('-loss_weight', type=float, default=0.05,
                       help="""Loss normalization weight.""")
